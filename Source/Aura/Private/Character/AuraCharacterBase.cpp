...
{
	Weapon->DetachFromComponent(FDetachmentTransformRules(EDetachmentRule::KeepWorld, true));//auto rep.
...
void AAuraCharacterBase::MulticastHandleDeath_Implementation()
{
	...
	Dissolve(); //destroy mesh/weapon effect
...
{
	// better is make TMap GT,montage
